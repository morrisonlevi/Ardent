...
abstract class SetTest extends TestCase {
    ...
    function test_count_sizeN_returnsN(array $add) {
        ...
        $this->assertCount($expectedSize, $set);
    }
    ...
    function testIntersectionEmpty() {
        ...
        $this->assertInstanceOf(__NAMESPACE__ . '\\Set', $intersection);
    ...
    function testRelativeComplementSelf() {
        ...
        $this->assertInstanceOf(__NAMESPACE__ . '\\Set', $complement);
    ...
    function testUnionSelf() {
        ...
        $union = $a->union($a);
        $this->assertInstanceOf(__NAMESPACE__ . '\\Set', $union);
