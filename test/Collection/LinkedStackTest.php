...
class LinkedStackTest extends \PHPUnit_Framework_TestCase {
    ...
    function testPushOne() {
        ...
        $this->assertTrue($stack->getIterator()->isEmpty());
        $this->assertCount(0, $stack);

        $stack->push(0);
        $this->assertFalse($stack->isEmpty());
        $this->assertFalse($stack->getIterator()->isEmpty());
    ...
    function testGetIteratorEmpty() {
        ...
        $this->assertInstanceOf(__NAMESPACE__ . '\\StackIterator', $iterator);
    }
    ...
    function testIteratorForeach() {
        ...
        $iterator = $stack->getIterator();
        $this->assertInstanceOf(__NAMESPACE__ . '\\LinkedStackIterator', $iterator);
